					...
					<div class="row" style="margin-bottom:30px;">
						<div class="col-12">
							<div class="titulo w-100">
								<button class="btn btn-success w-100">
									<div class="row">
										<div class="col-2 text-center" style="font-size:50px;"><i class="fa-regular fa-clock"></i></div>
										<div class="col-5 text-center" style="font-size:50px;"><?=date("d/m/Y")?></div>
										<div class="col-5 text-center" style="font-size:50px;"><?=date("H:i")?></div>
									</div>
								</button>
							</div>
						</div>
